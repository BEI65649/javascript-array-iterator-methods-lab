...
firstLast = people.map((name) => {      ///Good example of indexes as strings 
...
let isAdultPresent  = devs.some((person) => {
    return devs.year >= 'isAdultPresent'
// isAdultPresent = person.some((devs) => {
})
// check again
// Complete the exercise in the space below:
...
let isEveryone19OrOlder = devs.every((people) => {
    return devs.year >= 'isEveryone19Older'
